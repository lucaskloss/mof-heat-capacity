...
structure is generated by \texttt{utils/insert\_methane.py}. Each methane
...
insertion is handled by \texttt{utils/insert\_methane.py}; harmonic analysis is
handled by \texttt{utils/heat\_capacity.py}. The latter stores the run name,
