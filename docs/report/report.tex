...
\begin{equation}
  ...
  \quad\text{for every geometry covered by the pattern}.
...
$S_{pq}=0$ where $H_{pq}\ne0$ discards curvature and makes reconstruction
incorrect. For a Hessian, detecting the pattern is intrinsically a
...
SADMOF's call to \texttt{asdex.hessian\_coloring\_from\_sparsity} instead
